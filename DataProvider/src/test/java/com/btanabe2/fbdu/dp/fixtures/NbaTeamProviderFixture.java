...
public class NbaTeamProviderFixture {
    ...
    public static Map<String, String> getNbaTeamProviderMockWebRequestUrlsToPageStrings() throws IOException {
        ...
        urlToPageStringMap.put(SPORTS_VU_NBA_TEAM_INFO_URL, FileUtils.readFileToString(new File("./DataProvider/src/test/resources/webpages/nba-sportsvu-pages/nba-commonteamyear.json"), Charset.forName("UTF8")));
