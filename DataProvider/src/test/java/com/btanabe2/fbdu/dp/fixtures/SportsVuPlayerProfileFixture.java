...
public class SportsVuPlayerProfileFixture {
    ...
    public static Map<String, String> getSportsVuPlayerProfilePagesMappedToTheirUrls() throws IOException {
        ...
        urlToDocumentMap.put(SPORTS_VU_ALL_PLAYERS_URL, FileUtils.readFileToString(new File("./DataProvider/src/test/resources/webpages/nba-sportsvu-pages/nba-commonallplayers.json"), Charset.forName("UTF8")));

        Collection<File> testJsonFiles = FileUtils.listFiles(new File("./DataProvider/src/test/resources/webpages/nba-sportsvu-pages/playerinfo-pages"), new String[]{"json"}, false);
        for (File testFile : testJsonFiles) {
