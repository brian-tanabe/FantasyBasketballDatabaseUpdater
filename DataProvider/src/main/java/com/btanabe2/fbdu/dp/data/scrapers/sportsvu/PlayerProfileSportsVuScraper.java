...
public class PlayerProfileSportsVuScraper {
    ...
    public List<PlayerBiographyEntity> scrapeForPlayerBiographies(List<NbaTeamEntity> nbaTeams) throws IOException, ParseException, ExecutionException, InterruptedException {
        ...
        return scrapeAllPlayerInfoFromEachPlayersSportsVuPageInParallel(allActiveNbaPlayersSportsVuPlayerIds, nbaTeams);
    }
    ...
    private List<PlayerBiographyEntity> scrapeAllPlayerInfoFromEachPlayersSportsVuPageInParallel(List<Integer> allActivePlayerIds, List<NbaTeamEntity> nbaTeam) throws ExecutionException, InterruptedException {
        ...
        for (Future<PlayerBiographyEntity> future : futureList) {
            playerBiographyEntityList.add(future.get());
        }
